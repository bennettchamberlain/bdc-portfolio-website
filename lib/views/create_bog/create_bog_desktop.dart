...
class _CreateBogDesktop extends StatefulWidget {
  final CreateBogViewModel viewModel;

  const _CreateBogDesktop(this.viewModel);

  @override
  State<_CreateBogDesktop> createState() => _CreateBogDesktopState();
}

class _CreateBogDesktopState extends State<_CreateBogDesktop> {
  @override
  void initState() {
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        IconButton.filled(
                            onPressed: () {
                              widget.viewModel.openTextEditor();
                            },
                ...
                SizedBox(
                    ...
                    child: ListView.builder(
                      itemBuilder: (context, item) {
                        return widget.viewModel.elements[item].getWidget();
                      },
                                    ...
                                    return GridView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          ...
                                          return GestureDetector(
                                            onTap: () {
                                              widget.viewModel.openImageEditor(
