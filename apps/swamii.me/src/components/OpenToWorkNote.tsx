...
const OpenToWorkNote = () => {
  ...
  return (
    <button
      ...
      className="ml-1 mt-2 flex shrink-0 cursor-pointer items-center gap-0.5 self-center text-black transition-colors duration-300 select-none hover:text-neutral-500 sm:gap-1 md:-ml-3 md:mt-0"
    >
      <motion.svg
