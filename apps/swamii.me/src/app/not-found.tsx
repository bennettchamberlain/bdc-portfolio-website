  ...
  return (
    <div
      ...
      style={{
        ...
        color: "rgb(0, 0, 0)",
        textShadow: landed ? "0 2px 4px rgba(0, 0, 0, 0.15)" : "none",
...
function DropsContainer() {
  ...
  return (
    <div
      ...
      className="relative h-full w-full cursor-crosshair overflow-hidden bg-white select-none"
    >
      {drops.map((drop) => (
        <NumberDrop
          key={drop.id}
...
export default function NotFound() {
  return (
    <main className="flex h-screen w-full flex-col items-center justify-center overflow-hidden bg-white p-4">
      <div className="absolute inset-0 w-full h-full">
        <DropsContainer />
      </div>

      <div className="relative z-10 text-center max-w-md font-space-grotesk">
        <h1 className="font-display mb-2 text-7xl tracking-tight text-black md:text-8xl">
          404
        </h1>
        <p className="font-body mb-2 text-lg text-neutral-700 md:text-xl">
          This page doesnt exist...Awkward
        </p>
        <p className="font-body mt-4 mb-6 text-sm text-neutral-500">
          The page you&apos;re looking for doesn&apos;t exist or has been moved.
        </p>

        <Link
          href="/"
          className="font-body inline-block border-8 border-black bg-black px-8 py-3 font-bold text-white hover:bg-white hover:text-black"
        >
          Go Home
        </Link>
      </div>

      <p className="absolute top-8 z-10 animate-bounce text-sm text-neutral-500 select-none">
